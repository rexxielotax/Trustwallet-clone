...
export function Navbar() {
  ...
  <button className="hidden md:inline-flex h-9 w-9 items-center justify-center rounded-full hover:bg-muted" aria-label="Toggle dark mode">
    <Moon className="h-4 w-4" />
  </button>
  <button className="hidden md:inline-flex items-center gap-1 rounded-full border border-border px-3 py-1.5 text-sm hover:bg-muted">
